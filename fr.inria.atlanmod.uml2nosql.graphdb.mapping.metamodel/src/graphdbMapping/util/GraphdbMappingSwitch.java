 ...
 * @generated
 */
public class GraphdbMappingSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case GraphdbMappingPackage.PROPERTY_MAPPING: {
				PropertyMapping propertyMapping = (PropertyMapping)theEObject;
				T result = casePropertyMapping(propertyMapping);
				if (result == null) result = caseMapping(propertyMapping);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case GraphdbMappingPackage.ASSOCIATION_MAPPING: {
				AssociationMapping associationMapping = (AssociationMapping)theEObject;
				T result = caseAssociationMapping(associationMapping);
				if (result == null) result = caseMapping(associationMapping);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Association Mapping</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Association Mapping</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseAssociationMapping(AssociationMapping object) {
		return null;
	}
